...
var G__8319 = o;
(G__8319[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__8321 = o;
(G__8321[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__8565__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__8565 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__8565__delegate.call(this,args);};
G__8565.cljs$lang$maxFixedArity = 0;
G__8565.cljs$lang$applyTo = (function (arglist__8568){
var args = cljs.core.seq(arglist__8568);
return G__8565__delegate(args);
});
...
var G__8356 = props;
var G__8356__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8356,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8356);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8356__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__8360){
...
var props = map__8361__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8361__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__8367){
var map__8368 = p__8367;
var map__8368__$1 = (((((!((map__8368 == null))))?(((((map__8368.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8368.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8368):map__8368);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8368__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__8385 = jsprops;
(G__8385["defaultValue"] = value);

(G__8385["onChange"] = (function (p1__8382_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__8382_SHARP_);
}));
...
var vec__8395 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8395,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8395,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8395,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___8652 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___8652 == null)){
} else {
var key_8653 = temp__5739__auto___8652;
(jsprops["key"] = key_8653);
}
...
var temp__5739__auto___8656 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___8656 == null)){
} else {
var key_8658 = temp__5739__auto___8656;
reagent.impl.template.oset(jsprops,"key",key_8658);
}
...
var G__8404 = reagent.impl.template.__GT_NativeWrapper();
(G__8404["name"] = c);
...
var G__8437 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__8437) : reagent.impl.template.as_element.call(null,G__8437));
} else {
...
var len__4736__auto___8677 = arguments.length;
var i__4737__auto___8678 = (0);
while(true){
if((i__4737__auto___8678 < len__4736__auto___8677)){
args__4742__auto__.push((arguments[i__4737__auto___8678]));

var G__8681 = (i__4737__auto___8678 + (1));
i__4737__auto___8678 = G__8681;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8474){
var G__8475 = cljs.core.first(seq8474);
var seq8474__$1 = cljs.core.next(seq8474);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8475,seq8474__$1);
}));
...
break;
default:
var G__8713 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__8713;
continue;
...
var n__4613__auto___8730 = a.length;
var i_8731 = (0);
while(true){
if((i_8731 < n__4613__auto___8730)){
(a[i_8731] = reagent.impl.template.as_element((a[i_8731])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___8734 = a.length;
var i_8735 = (0);
while(true){
if((i_8735 < n__4613__auto___8734)){
var val_8736 = (a[i_8735]);
if(((cljs.core.vector_QMARK_(val_8736)) && ((reagent.impl.template.key_from_vec(val_8736) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_8735] = reagent.impl.template.as_element(val_8736));

var G__8742 = (i_8735 + (1));
i_8735 = G__8742;
continue;
} else {
}
...
var ctx = ({});
var vec__8508 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8508,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8508,(1),null);
...
var G__8526 = (cljs.core.count(argv) - first_child);
switch (G__8526) {
case (0):
